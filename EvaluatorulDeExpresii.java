...
public class EvaluatorulDeExpresii {
    ...
    private static String[] toStringArray(String expresie) {
    ...
    private static StringBuilder postfix(String[] input) {
    ...
    private static int execution(String[] postfix) {
    ...
    public static void main(String[] args) {
      ...
      System.out.println("Forma postfix este: " + postfix);
...
//      String expresie = "9 1 + 8 -";
//      expresie = "7 2 - 3 1 + + 1 +";
//      expresie = "3 2 1 + 2 3 2 ^ ^ * + 8 5 1 2 * 2 / - / -";
//      String[] arr= toStringArray(expresie);
//      execution(arr);
    }
}
